import svgPaths from "./svg-egvceuz6nw";
...
function Node() {
  return (
    <div className="relative rounded-[12px] shrink-0 w-full" data-name="Node">
...
function Node2() {
  return (
    <div className="bg-[#fcfafa] relative rounded-[12px] shrink-0 w-full" data-name="Node">
      <div className="size-full">
        <div className="box-border content-stretch flex flex-col gap-[6px] items-start px-[16px] py-[12px] relative w-full">
          <Title2 />
          <Description2 />
