import svgPaths from "./svg-7mtmmw9lcd";
...
function Text2() {
  return (
    <div className="content-stretch flex gap-[8px] items-center justify-center relative shrink-0 w-full" data-name="Text">
      <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[#151313] text-[14px] text-nowrap whitespace-pre">Telecom Italia S.p.A.</p>
    </div>
  );
}
...
function Info1() {
  return (
    <div className="bg-[#f6f3ee] relative rounded-[12px] shrink-0 w-full" data-name="Info">
