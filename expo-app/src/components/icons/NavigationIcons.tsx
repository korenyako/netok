...
export function NetokLogoIcon({ size = 24, color = 'currentColor' }: IconProps) {
  return (
...
// Re-export as named aliases for consistency with desktop
export { ShieldCheck as ShieldIcon } from './UIIcons';
export { Activity as ToolsIcon } from './UIIcons';
export { Settings as SettingsIcon } from './UIIcons';
