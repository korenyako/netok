...
Netok Mobile — Android app built with Expo SDK 54, ported from the desktop React/Tauri UI. Uses React Navigation for routing, Zustand for state management, react-native-svg for icons. All network features currently run on mock data.
...
- **react-native-svg** v15 (icons)
- **expo-navigation-bar** v5 (Android system navigation bar)
- **expo-network** v7 (network info)
