...
export function OpenDnsDetailScreen({ onBack }: OpenDnsDetailScreenProps) {
  ...
  const [selectedVariant, setSelectedVariant] = useState<OpenDnsVariant>('familyshield');
      ...
      try {
        ...
        if (provider.type === 'OpenDns') {
          ...
          if (variant === 'FamilyShield') {
            ...
            setSelectedVariant('familyshield');
          } else if (variant === 'Home') {
            setCurrentVariant('home');
            setSelectedVariant('home');
          }
        }
      } catch (err) {
  ...
  const handleApply = async () => {
    try {
      ...
      const apiVariant: ApiOpenDnsVariant =
        selectedVariant === 'familyshield' ? 'FamilyShield' : 'Home';
